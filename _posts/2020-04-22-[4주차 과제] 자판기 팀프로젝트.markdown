...
- 잔돈 반환 부
  ...
  ![결과 1](C:\Users\이상진\my-awesome-site\images\결과 1.png)

  ![결과 2](C:\Users\이상진\my-awesome-site\images\결과 2.png)
  ...
  두번 째 사진에서는 거스름 돈의 동전 개수가 다른것을 확인할 수 있었습니다.